...
public interface OrderItemDAO {
	 ...
	 */
	List<OrderItem> findBookItemsByOrder(final Order order) throws DaoException, OrderNotFoundException;
	 ...
	 * @throws OrderNotFoundException when not found an order in the database.
	 */
	List<OrderItem> findCellphoneItemsByOrder(final Order order) throws DaoException, OrderNotFoundException;
	 ...
	 * @throws OrderNotFoundException when not found an order in the database.
	 */
	List<OrderItem> findDvdtemsByOrder(final Order order) throws DaoException, OrderNotFoundException;
	 ...
	 * @throws OrderNotFoundException when not found an order in the database.
	 */
	List<OrderItem> findLaptopItemsByOrder(final Order order) throws DaoException, OrderNotFoundException;
	 ...
	 * @throws OrderNotFoundException when not found an order in the database.
	 */
	List<OrderItem> findMagazienItemsByOrder(final Order order) throws DaoException, OrderNotFoundException;
}
